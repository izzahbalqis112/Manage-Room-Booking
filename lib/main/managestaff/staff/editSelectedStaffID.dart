...
class EditSelectedStaffData extends StatefulWidget {

  final String managerID;

  const EditSelectedStaffData({Key? key, required this.managerID}) : super(key: key);

  @override
  _EditSelectedStaffDataState createState() => _EditSelectedStaffDataState();
}

class _EditSelectedStaffDataState extends State<EditSelectedStaffData> {
  ...
  Future<void> fetchManagerData() async {
    try {
      ...
      await _firestore.collection('staffAccount').doc(widget.managerID).get();
  ...
  Future<void> _updateUserDetails() async {
    try {
      ...
      await _firestore.collection('staffAccount').doc(widget.managerID).update({
