...
import 'editSelectedStaffID.dart';
...
class _ViewAllStaffState extends State<ViewAllStaff> {
  ...
  Future<void> _deleteSelectedManagerData(String managerID, String currentUserEmail) async {
    try {
      ...
      await FirebaseFirestore.instance.collection('staffAccount').doc(managerID).delete();
  ...
  void _showSuccessDialog(BuildContext context) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text("Success"),
          content: Text("Staff added successfully! Please remember to insert the staff's email and password into Firebase Auth."),
          actions: [
            TextButton(
              onPressed: () {
